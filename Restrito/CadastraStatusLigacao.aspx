    ...
    <div class="x_content">
        ...
        <contenttemplate>
            ...
            <div id="demo-form" class="col-sm-4" data-parsley-validate>
                ...
                <p>
                    Sim:
                    <input type="radio" class="flat" name="tenta" id="tentaS" value="S" checked required />
                    Não:
                ...
                <p>
                    Sim:
                    <input type="radio" class="flat" name="ativo" id="ativoS" value="S" checked required />
                    Não:
                            ...
                            <asp:TemplateField HeaderText="Ações">
                                <ItemTemplate>
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary btn-editar"
                                        ...
                                        data-ativo='<%# Eval("Ativo") %>'>
                                        ✏️</button>
                                    <% } %>


                                    <% if ((bool)ViewState["PermitirExclusao"])
                                        { %>
